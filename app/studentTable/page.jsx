...
export default function StudentsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <button className="hidden border p-2 bg-red-500 cursor-pointer" onClick={()=>deleteAllEntries()}>Delete all entries</button>
        ...
        <table className="min-w-full border border-gray-600">
          <thead className="bg-gray-500 text-sm">
            <tr>
              ...
              <th className="border px-3 py-2">probab ADHD</th>
              <th className="border px-3 py-2">probab Dyslexia</th>
            </tr>
          </thead>
          <tbody>
            {records.map((rec, i) => (
              <tr key={i} className="text-center text-sm">
                ...
                <td className="border px-3 py-2 font-medium">
                  {rec.probabilities["ADHD"]}
                </td>
                <td className="border px-3 py-2 font-medium">
                  {rec.probabilities["Dyslexia"]}
                </td>
              </tr>
            ))}
          </tbody>
